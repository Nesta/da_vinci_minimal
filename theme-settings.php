 ...
 */
function da_vinci_minimal_form_system_theme_settings_alter(&$form, &$form_state) {
  $google_fonts = [
    'ABeeZee' => 'ABeeZee',
    'Abel' => 'Abel',
  ...
  $form['da_vinci_minimal_settings'] = [
    '#type'        => 'vertical_tabs',
  ...
  $form['general'] = [
    '#type'  => 'details',
    '#title' => t('General'),
    '#group' => 'da_vinci_minimal_settings',
  ];
  ...
  $form['general']['body-font'] = [
    ...
    '#default_value' => theme_get_setting('body-font', 'da_vinci_minimal'),
  ...
  $form['general']['header-font'] = [
    ...
    '#empty_option'  => t('- Default -'),
    '#options'       => array_flip($google_fonts),
    '#default_value' => theme_get_setting('header-font', 'da_vinci_minimal'),
  ...
  $form['general']['search-placeholder'] = [
    ...
    '#default_value' => theme_get_setting('search-placeholder', 'da_vinci_minimal'),
  ...
  $form['css']['styling'] = [
    ...
    '#default_value' => theme_get_setting('styling', 'da_vinci_minimal'),
  ...
  $form['css']['styling_code'] = [
    ...
    '#default_value' => theme_get_setting('styling_code', 'da_vinci_minimal'),
  ...
  $form['#attached']['library'][] = 'da_vinci_minimal/theme-settings';
}
